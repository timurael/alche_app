#!/usr/bin/env python3
"""
alche P&L Excel Generator v4 — 300K Variant
===================================================================
300K variant: Pre-seed funding reduced from EUR 500K to EUR 300K @ EUR 2.5M cap.
All other assumptions identical to v4 base model.
...
ws_a.cell(row=r-1, column=2).number_format = '0%'
put_assumption(r, "Pre-seed funding (EUR)", 300000, "EUR 300K @ EUR 2.5M cap — single source for all cash start calculations"); r += 1  # B142
ws_a.cell(row=r-1, column=2).number_format = EUR_FMT
...
ws.cell(row=2, column=1, value="Pre-Seed | EUR 300K @ EUR 2.5M Cap | v4: Annual subs + B2B + Gift Cards + Corrected App/Rent costs").font = f_subtitle
...
cgm_rev_row = ROW
# Growth Curves row 21 (CGM Active Users) × Assumptions!B141 (EUR 15/user/mo)
...
# ─── SAVE ───
output_path = "/Users/timoel/Downloads/pitchbook/financials/models/alche-pnl-24mo-v4-300k.xlsx"
wb.save(output_path)
